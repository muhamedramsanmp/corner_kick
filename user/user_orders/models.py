...
class Order(models.Model):
    ...
    def allowed_next_statuses(self):
        ...
        return self.STATUS_FLOW.get(self.order_status, [])
    ...
    show_status_message = models.BooleanField(default=False)
    ...
    coupon = models.ForeignKey(
        "admin_coupon.Coupon", on_delete=models.SET_NULL, null=True, blank=True
    )
...
class ReturnRequest(models.Model):
    ...
    refund_method = models.CharField(max_length=50, choices=REFUND_METHODS)
