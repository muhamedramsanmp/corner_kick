...
def edit_coupon(request, coupon_id):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            coupon.usage_limit_per_user = int(
                request.POST.get(
                    "usage_limit_per_user"
                )
            )

            coupon.total_usage_limit = int(
                request.POST.get(
                    "total_usage_limit"
                )
            )

            coupon.start_date = request.POST.get(
                "start_date"
            )

            coupon.end_date = request.POST.get(
                "end_date"
            )
